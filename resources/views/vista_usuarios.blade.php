      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                <td>piedad@gmail.com</td>
                <td>Piedad Guzman Apanco</td>
                <td>pily0978</td>
                <td>San Miguel Xochiltecatitla</td>
                <td>Administrador</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-center" style="background:#208454; color:white">
                <h3 class="modal-title" id="modalLabel"> Registrar Usuario</h3>
            ...
            <div class="modal-body">
                <form id="formRegistroUsuario">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" placeholder="Ingrese el correo" required>
                    </div>

                    <div class="form-group">
                        <label for="password">Contraseña</label>
                        <input type="password" class="form-control" id="email" placeholder="Ingrese la contraseña" required>
                    </div>

                    <div class="form-group">
                        <label for="email">Nombre Completo</label>
                        <input type="email" class="form-control" id="password" placeholder="Ingrese el nombre completo" required>
                    </div>

                    <div class="form-group">
                      <label for="email">Nombre de Usuario</label>
                      <input type="email" class="form-control" id="password" placeholder="Ingrese el nombre de usuario" required>
                  </div>
                  <div class="form-group">
                    <label for="email">Direccion</label>
                    <input type="email" class="form-control" id="password" placeholder="Ingrese la direccion" required>
                </div>
